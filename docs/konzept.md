...
| Status | Leitkonzept; Phase 7, Software **R2.0.0** (Journal-Modell nach Design-Review) |
...
### 3.3 Bearbeitung (Phase 7, Software R2.0.0)
...
Reise
 └── Journal-Einträge (`trip_sections`), chronologisch gemischt
      ...
      └── Transfer (Spanne, Verkehrsmittel, Mitglieder)
...
Aktueller Konzeptstand: **Phase 7**, Software **R2.0.0** (Journal-Modell nach Design-Review: Tag/Aufenthalt/Transfer als Abschnitte, Medienpool, Journal-Zeit; Timeline, Bewertungen, Inspektor, Track-Vorschauen, Karten-Leiste, Kreis-Detail, Rückgängig/Wiederherstellen). Windows-Endnutzerpaket (onedir/Zip, optional Inno-Setup) ist baubar und keine eigene Fachphase. HTML-Export folgt in Phase 8.
