...
| Status | Leitkonzept; Phase 7, Software **R2.1.1** |
...
### 3.3 Bearbeitung (Phase 7, Software R2.1.1)
...
Aktueller Konzeptstand: **Phase 7**, Software **R2.1.1** (Journal-Modell nach Design-Review plus Verbindungslinien; Kartenbedienung: Cover-Zoom, Fit-Reise, vorab zentriertes Foto-Popup mit Blättern und Schieber-Zoom; Track-Bewertung wie Medien; Timeline, Inspektor, Track-Vorschauen, Karten-Leiste, Rückgängig/Wiederherstellen). Windows-Endnutzerpaket (onedir/Zip, optional Inno-Setup) ist baubar und keine eigene Fachphase. HTML-Export folgt in Phase 8.
