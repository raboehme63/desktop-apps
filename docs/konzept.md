...
| 7 | Der Mensch übernimmt die Redaktion (Tag/Aufenthalt/Transfer, Pool, Journal-Zeit, Bewertungen, Inspektor). |
| 8 | Die Reise verlässt die App. |
| 9–10 | Die Auswahl wird begründet (Qualität, Dubletten). |

Aktueller Konzeptstand: **Phase 7**, Software **R2.0.0** (Journal-Modell nach Design-Review: Tag/Aufenthalt/Transfer als Abschnitte, Medienpool, Journal-Zeit; Timeline, Bewertungen, Inspektor, Track-Vorschauen, Karten-Leiste und Kreis-Detail). Windows-Endnutzerpaket (onedir/Zip, optional Inno-Setup) ist baubar und keine eigene Fachphase. HTML-Export folgt in Phase 8.
