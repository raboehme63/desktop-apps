...
| Import | Pfadwahl, Analyse, Synchronisieren (fehlende entfernen, neue in Timeline oder Pool), Fortschritt, Zähler (Fotos, Videos, MapTracks, ActivityTracks, Flüge, Sonstige, Ort, Texte, Fehler), gemerkte Activity-DB, vollständige Dateitabelle, Vorschau aller Galerie-Typen außer Text, Thumbnail-Schieber | unverändert |
