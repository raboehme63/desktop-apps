...
| Export | Ausgabetyp, Modus **Vorschau** / **Editiermodus**, blätterbare Travelbook-Vorschau; Format erst beim Exportieren | HTML-Schreiben, Drag-and-drop, PDF/LaTeX/CEWE |
