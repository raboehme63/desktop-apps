...
| Version | 3.1 (Software **R3.1.0**) |
| Stand | 31. August 2026 |
| Status | verbindlich für die Umsetzung; Phase 7 plus Medien-Pipeline, Software R3.1.0 |
...
| FA-121 | Muss | HTML-Export als erstes vollständiges Format, Ausgabetyp **Travelbook**: Buchdeckel, Titelseite (links leer, rechts Reisetitel mittig), Reiseübersicht (links Länder aus Katalog mit Umriss, Name und Flagge + Kennzahlen Tage/Abschnitte/Fotos/YouTube/Gleitschirmflüge, rechts statische Karte). Kennzahl Tage aus Projekt **von–bis** (inklusiv; sonst Abschnittsspanne). Chronik. Pro veröffentlichtem Abschnitt zuerst eine Doppelseite (links Titelbild + Abschnittsdaten, YouTube inkl. QR; rechts Medien-Template). Weitere Doppelseiten im **Editiermodus** mit Templates 1–8 Medien (Foto/Video/Track) oder Tagebucheintrag, Befüllen per Drag-and-drop. Blättern wie in einem Buch. Templates HTML/CSS getrennt (Jinja2). Ausgeblendete Abschnitte fehlen wie auf der Karte. | geplant (Phase 8) |
| FA-122 | Soll | PDF über austauschbares Backend (HTML→Druckengine oder LaTeX→PDF); **kein** PyMuPDF als Zwangsabhängigkeit. Nur für Buch-Ausgabetypen (Travelbook, Jahrbuch). | geplant |
...
| Bereich | R3.1.0 (Phase 7 plus Medien-Pipeline) | Erste vollständige Version |
| --- | --- | --- |
| Projekt | Name, Ordnerpfad, Anlegen, Öffnen, Speichern, Einstellungen (`settings.toml`, Dialog mit Schieber); Fenstertitel mit Version R3.1.0 | plus zuletzt verwendete Projekte in der UI |
...
| Export | Ausgabetyp, blätterbare Travelbook-Vorschau; Format erst beim Exportieren | HTML-Schreiben, Drag-and-drop, PDF/LaTeX/CEWE |
...
Windows-Paketierung (`packaging/`) ist **keine eigene Fachphase**. Sie liefert die aktuelle Software (R3.1.0) als EXE/Zip (und optional Setup) an Endnutzer, ohne die Phasenfolge zu ändern. Build-Anleitung: [packaging/README.md](../packaging/README.md).
...
| OP-15 | Travelbook-Chronik nach der Übersicht | festgelegt: erste Doppelseite je Abschnitt (Intro + photos_1); weitere Spreads mit photos_1–8 oder journal. Wetter-Slot ohne Quelle. |
