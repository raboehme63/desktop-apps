...
| FA-121 | Muss | HTML-Export als erstes vollständiges Format: Titel, Zeitraum, Tage, Texte, Fotos, Bildunterschriften, Abschnitte; Templates HTML/CSS getrennt (Jinja2). Ausgeblendete Abschnitte (`trip_sections.hidden`, `TimelineSnapshot.published_entries`) fehlen wie auf der Karte. | geplant (Phase 8) |
