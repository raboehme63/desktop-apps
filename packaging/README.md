...
| Zip | `dist/Reisetagebuch-3.4.0-windows.zip` | Portable Weitergabe |
| Setup | `dist/Reisetagebuch-3.4.0-setup.exe` | Installer (Startmenü, optional Desktop), nur mit Inno Setup |
