...
| Zip | `dist/Reisetagebuch-2.0.0-windows.zip` | Portable Weitergabe |
| Setup | `dist/Reisetagebuch-2.0.0-setup.exe` | Installer (Startmenü, optional Desktop), nur mit Inno Setup |
