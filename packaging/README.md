...
| Zip | `dist/Reisetagebuch-3.1.0-windows.zip` | Portable Weitergabe |
| Setup | `dist/Reisetagebuch-3.1.0-setup.exe` | Installer (Startmenü, optional Desktop), nur mit Inno Setup |
