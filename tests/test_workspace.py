...
def test_thumb_zoom_persists(tmp_path: Path, monkeypatch) -> None:  # noqa: ANN001
    ...
    assert workspace.media_thumb_zoom() == DEFAULT_THUMB_ZOOM
    workspace.set_import_thumb_zoom("nope")
    assert workspace.import_thumb_zoom() == DEFAULT_THUMB_ZOOM
